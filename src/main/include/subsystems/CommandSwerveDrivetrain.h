...
public:
     ...
     * \param modules             Constants for eachdrive specific module
     */
    ...
    frc::ChassisSpeeds ChassisSpeedsCTREToFrc(ctre::phoenix6::swerve::impl::ChassisSpeeds inputChassisSpeed);
    ctre::phoenix6::swerve::impl::ChassisSpeeds ChassisSpeedsFrcToCTRE(frc::ChassisSpeeds inputChassisSpeed);
